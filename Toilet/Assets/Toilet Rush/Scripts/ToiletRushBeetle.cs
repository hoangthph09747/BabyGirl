...
{
    public class ToiletRushBeetle : MonoBehaviour
    {
        ...
        private void OnTriggerEnter2D(Collider2D collision)
        {
            ...
            //transform.DOMove(character.BeetlePos.position, .5f);
            SoundManager_BabyGirl.Instance.DoMove(transform,character.BeetlePos.position, .5f);
            transform.localScale = new Vector3(-2.15f, 2.15f, 1);

            character.TouchBeetle();
        }
