...
Shader "Spaventacorvi/Prismatic/Prismatic B - Rough desaturated" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3 diffuseColor = lerp(lerp((wvwvww*node_3784),node_3784,(1.0 - wxxwww)),wvwvww,(vvxwwx_var.rgb*vvxxvv));
