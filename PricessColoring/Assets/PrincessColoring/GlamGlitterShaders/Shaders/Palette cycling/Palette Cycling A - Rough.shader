...
Shader "Spaventacorvi/Palette Cycling/Palette Cycling A - Rough" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3 diffuseColor = (_Color.rgb*xvwvwx_var.rgb);
                ...
                float4 wvxwxw = tex2Dlod(vvxxww,float4(TRANSFORM_TEX(vwwvxw, vvxxww),0.0,1.0));
