...
Shader "Spaventacorvi/Palette Cycling/Palette Cycling D - Rough step" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3 node_3035 = (_Color.rgb*xvwvwx_var.rgb);
                float3 diffuseColor = node_3035;
                ...
                float3 node_2794 = (wvxwxw.rgb*wwvxvx*(1.0 - xvwvwx_var.rgb));
                float3 emissive = node_2794;
