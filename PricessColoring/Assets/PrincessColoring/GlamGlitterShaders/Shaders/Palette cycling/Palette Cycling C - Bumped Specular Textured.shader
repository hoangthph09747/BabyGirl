...
Shader "Spaventacorvi/Palette Cycling/Palette Cycling C - Bumped Specular Textured" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3 wvvxxv_var = UnpackNormal(tex2Dlod(wvvxxv,float4(TRANSFORM_TEX(i.uv0, wvvxxv),0.0,0.0)));
                float3 normalLocal = wvvxxv_var.rgb;
                ...
                float2 vwwvxw = ((float2(lerp(xvxwww_var.rgb,dot(xvxwww_var.rgb,float3(0.3,0.59,0.11)),1.0).r,0.0)*vwvxwv)+float2((wvvxxw.g*wvwwxv),0.0));
