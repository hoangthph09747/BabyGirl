...
public class CameraZoom : MonoBehaviour
{
    ...
    [Range(0, 30)] public float speed = 5; //lerp speed
    ...
    private static float factor = 0.5f; //offset multiply factor
    ...
    private void LerpToSize()
    {
        ...
        targetCamera.orthographicSize = Mathf.Lerp(targetCamera.orthographicSize, currentOrthographicSize,
